...
def gen_uint(length):
    options = [0, 0, 0, 0, 0, 0, 8, 8, 8, 8, 8, 16, 16, 32 , 64, 127, 255]
    value = 0
    if length == 0 or length == 256:
        value = random.randint(0, 2**random.choice(options))
    elif length == 128:
        value = random.randint(0, 2**random.choice(options[:-1]))
    elif length == 64:
        value = random.randint(0, 2**random.choice(options[:-2]))
    elif length == 32:
        value = random.randint(0, 2**random.choice(options[:-3]))
    else:
...
def gen_int(length):
    options = [0, 0, 0, 0, 0, 0, 7, 7, 7, 7, 7, 15, 15, 31, 63, 127, 255]
    value = 0
    if length == 0 or length == 256:
        value = random.randint(-2**random.choice(options), 2**random.choice(options))
    elif length == 128:
        value = random.randint(-2**random.choice(options[:-1]), 2**random.choice(options[:-1]))
    elif length == 64:
        value = random.randint(-2**random.choice(options[:-2]), 2**random.choice(options[:-2]))
    elif length == 32:
        value = random.randint(-2**random.choice(options[:-3]), 2**random.choice(options[:-3]))
    else:
